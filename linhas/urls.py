...
urlpatterns = [
    ...
    path("buscar-cliente-completo/", views.buscar_cliente_completo, name="buscar_cliente_completo"),
    ...
    path("apagar-fidelidade/", views.apagar_fidelidade, name="apagar_fidelidade"),
